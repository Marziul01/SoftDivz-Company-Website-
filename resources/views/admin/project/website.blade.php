...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Website Projects</a></li>
        </ol>
    </div>
</div>
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($project->wordpress == 1)
                                        <a class="btn btn-sm btn-primary">Wordpress</a>
                                        @else
                                        <a class="btn btn-sm btn-success"> Custom Coded </a>
                                        @endif
                                    </td>
                                    <td>{{  $project->name }}</td>
                                    <td>{{  $project->link }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-warning">Ongoing</a>
                                        @elseif ($project->status == 2)
                                        <a class="btn btn-sm btn-success"> Completed </a>
                                        @else
                                        <a class="btn btn-sm btn-danger"> On Hold </a>
                                    @endif</td>
                                    <td>
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add New Website Project</h5>
        ...
        <form action="{{ route('project.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="modal-body">
                        <input type="hidden" value="Website" name="type" class="d-none">
                        ...
                        <div class="form-group">
                            <label class="col-form-label">Is it WordPress Site?</label>
                            <select class="form-control" name="wordpress" required>
                 ...
                 <form action="{{ route('project.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                     ...
                     <input type="hidden" value="Website" name="type" class="d-none">
                        ...
                        <div class="form-group">
                            <label class="col-form-label">Is it WordPress Site?</label>
                            <select class="form-control" name="wordpress" required>
                                <option value="1" {{ $project->wordpress == 1 ? 'selected' : '' }}> Yes </option>
                                <option value="2" {{ $project->wordpress == 2 ? 'selected' : '' }}> No </option>
                            </select>
                        </div>
