...
<section class="section-lg contact">
    ...
    <!-- background shapes -->
    <img class="contact-bg-1 up-down-animation" src="{{ asset('frontend-assets') }}/images/background-shape/feature-bg-2.png" alt="background-shape">
    <img class="contact-bg-2 left-right-animation" src="{{ asset('frontend-assets') }}/images/background-shape/green-half-cycle.png" alt="background-shape">
    <img class="contact-bg-3 up-down-animation" src="{{ asset('frontend-assets') }}/images/background-shape/green-dot.png" alt="background-shape">
    <img class="contact-bg-4 left-right-animation" src="{{ asset('frontend-assets') }}/images/background-shape/service-half-cycle.png" alt="background-shape">
    <img class="contact-bg-5 up-down-animation" src="{{ asset('frontend-assets') }}/images/background-shape/feature-bg-2.png" alt="background-shape">
</section>
